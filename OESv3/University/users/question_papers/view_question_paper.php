...
if(isset($_GET['id']) && $_GET['id'] > 0){
    $qry = $conn->query("SELECT q.*,CONCAT(cc.name,' - ',c.name) as `class` from `tbl_question_paper_list` q inner join tbl_class_list c on q.class_id = c.id inner join tbl_course_list cc on c.course_id = cc.id where q.id = '{$_GET['id']}' ");
    if($qry->num_rows > 0){
        ...
        <div class="card-body">
            <div class="container-fluid">
                ...
                <div class="text-right">
                    <button class="btn btn-default border btn-sm btn-flat" id="add_Excel_question"><i class="fa fa-plus"></i> Upload as Excel</button>
                    ...
                    <div class="col-12 col-sm-4 col-md-4 col-sm-12 col-xs-12">
                        <div class="info-box">
                            ...
                            <div class="info-box-content">
                                ...
                                <?php 
                                    $question = $conn->query("SELECT * FROM tbl_question_list where question_paper_id = '{$id}' and `type` = 1 ")->num_rows;
                    ...
                    <div class="col-12 col-sm-4 col-md-4 col-sm-12 col-xs-12">
                        <div class="info-box">
                            ...
                            <div class="info-box-content">
                                ...
                                <span class="info-box-number text-right">
                                <?php 
                                    $question = $conn->query("SELECT * FROM tbl_question_list where question_paper_id = '{$id}' and `type` = 2 ")->num_rows;
                                    echo format_num($question);
                                ?>
                                <?php ?>
                                </span>
                    ...
                    <div class="col-12 col-sm-4 col-md-4 col-sm-12 col-xs-12">
                        <div class="info-box">
                            ...
                            <div class="info-box-content">
                                ...
                                <span class="info-box-number text-right">
                                <?php 
                                    $question = $conn->query("SELECT * FROM tbl_question_list where question_paper_id = '{$id}' and `type` = 3 ")->num_rows;
                                    echo format_num($question);
                                ?>
                                <?php ?>
                                </span>
                ...
                <?php if(isset($_GET['type'])): ?>
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            <?php 
                            $questions = $conn->query("SELECT * FROM `tbl_question_list` where `type` = '{$_GET['type']}' and question_paper_id = '{$id}'");
...
<script>
    $(function(){
        ...
        $('#add_Excel_question').click(function(){
            uni_modal("<i class='fa fa-plus'></i> Upload Excel file","question_papers/manage_question_Excel.php?qid=<?= isset($id) ? $id : '' ?>","large")
        })
