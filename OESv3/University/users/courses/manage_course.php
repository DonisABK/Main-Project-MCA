...
if(isset($_GET['id']) && $_GET['id'] > 0){
    $qry = $conn->query("SELECT * from `tbl_course_list` where id = '{$_GET['id']}' ");
    if($qry->num_rows > 0){
...
<div class="container-fluid">
	<form action="" id="type-form">
		...
		<div class="form-group">
			...
			<input type="text" name="stream" id="stream" class="form-control form-control-sm rounded-0" value="<?php echo isset($stream) ? $stream : ''; ?>"  required/>
		</div>
		<div class="form-group">
