<?php 
$user = $conn->query("SELECT * FROM tbl_hod where id ='".$_settings->userdata('id')."'");
foreach($user->fetch_array() as $k =>$v){
	$meta[$k] = $v;
}
$college = $conn->query("SELECT * FROM tbl_college where id ='".$meta->college_id"'");
		...
		<div class="container-fluid">
			...
			<form action="" id="manage-user">	
				...
				<div class="form-group">
					...
					<input type="text" name="college_name" id="college_name" class="form-control" value="<?php echo isset($row['college_name']) ? $meta['college_name']: '' ?>" required  autocomplete="off">
				</div>
				<div class="form-group">
