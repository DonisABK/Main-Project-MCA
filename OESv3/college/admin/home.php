            ...
            <div class="info-box">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number">
                  <?php 
                    $course = $conn->query("SELECT * FROM tbl_course_list where delete_flag = 0")->num_rows;
          ...
          <div class="col-12 col-sm-3 col-md-3 col-sm-12 col-xs-12">
            <div class="info-box">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number">
                  <?php 
                    $class = $conn->query("SELECT * FROM tbl_class_list where delete_flag = 0 ")->num_rows;
          ...
          <div class="col-12 col-sm-3 col-md-3 col-sm-12 col-xs-12">
            <div class="info-box">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number">
                  <?php 
                    $qp = $conn->query("SELECT * FROM tbl_question_paper_list where delete_flag = 0 ")->num_rows;
                    echo format_num($qp);
                  ?>
                  <?php ?>
                </span>
          ...
          <div class="col-12 col-sm-3 col-md-3 col-sm-12 col-xs-12">
            <div class="info-box">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number">
                  <?php 
                    $ruser = $conn->query("SELECT * FROM tbl_registered_user_list where delete_flag = 0 ")->num_rows;
