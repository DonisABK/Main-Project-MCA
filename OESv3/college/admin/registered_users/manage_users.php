			...
			<form id="update-frm" action="" method="post">
				...
				<div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="uname" id="uname" pattern="[A-Za-z]+"  class="form-control form-control-sm form-control-border" value="<?= isset($uname) ? $uname : '' ?>" required="required">
                                    </div>
                                </div>
</div>
				<div class="row">
				...
				<div class="row">
					<div class="col-md-4">
						<div class="form-group">
							<label for="status" class="control-label text-sm">Status</label>
